...
from onmt.inputters.lattice_dataset import lattice_sort_key, LatticeDataReader
from onmt.inputters.datareader_base import DataReaderBase


str2reader = {
    "text": TextDataReader, "img": ImageDataReader, "audio": AudioDataReader,
    "vec": VecDataReader, "lattice" : LatticeDataReader}
str2sortkey = {
    'text': text_sort_key, 'img': img_sort_key, 'audio': audio_sort_key,
    'vec': vec_sort_key, "lattice": lattice_sort_key}
...
__all__ = ['Dataset', 'load_old_vocab', 'get_fields', 'DataReaderBase',
           ...
           'VecDataReader', 'LatticeDataReader']
